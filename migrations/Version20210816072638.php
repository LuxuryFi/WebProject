 ...
 */
final class Version20210816072638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD amount INT DEFAULT NULL, ADD price DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart DROP amount, DROP price');
    }
}
